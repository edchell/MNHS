 ...
 <?php
    ...
    ?>
       <div class="form-group">
        <label class="control-label col-sm-6" for="fname">Firstname:</label>
      <div class="col-sm-8">  
    ...
    <br>
    <div class="form-group">
      <label class="control-label col-sm-6" for="lname">Lastname:</label>
      <div class="col-sm-8">          
    ...
    <div class="form-group">
      <label class="control-label col-sm-6" for="user">User:</label>
      <div class="col-sm-8">          
    ...
    <br>
    <div class="form-group">
      <label class="control-label col-sm-6" for="pwd">User Type:</label>
      <div class="col-sm-8">   
