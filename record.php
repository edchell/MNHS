...
success:function(data)
{
   $("#fetch-feild").html(data);
    ...
    while($sy = mysqli_fetch_assoc($query)){ ?>
      ...
      <a class='btn btn-primary' href="rms.php?page=addrecord_update&id=<?php echo $_GET['id'] ?>&sy=<?php echo $sy['school_year'] ?>&prog=<?php echo $_GET['prog'] ?>"><i class="fa fa-plus"> Update Record</i></a>
      <?php
    } ?>
    </div>
    <br>
