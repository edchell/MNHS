...
<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
    ...
    <center> Total Male Students </center> 
        ...
        <div class="col-xl-3 col-lg-3 col-md-6 mb-20">
            <div class="card-box height-30-p widget-style3" style="background-color: #f9e6ff;"> <!-- Light Pink color -->
                <div class="d-flex flex-wrap">
                    <div class="widget-data">
        ...
        <div class="col-xl-3 col-lg-3 col-md-6 mb-20">
            <div class="card-box height-30-p widget-style3" style="background-color: #dfffd6;"> <!-- Light Green color -->
                <div class="d-flex flex-wrap">
                    <div class="widget-data">
 ...
 <!-- Subjects Section -->
<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
    <div class="card-box height-30-p widget-style3" style="background-color: #fde0e0;"> <!-- Soft peach color -->
        <div class="d-flex flex-wrap">
            <div class="widget-data">
