  ...
  <table id="students" class="table table-hover table-bordered">
    ...
    <form method="post" action="update_subject.php">
      ...
      <td><?php echo $row['USER_ID'] ?></td>
        ...
        <a data-toggle="modal" data-id="<?php echo $row['USER_ID'] ?>" id="getUser" onclick="deleteUser(<?php echo $row['USER_ID'] ?>)"><i class="fa-solid fa-x" aria-hidden="true"></i> delete</a></td>
      </tr>
      </form>
      <?php
    } mysqli_close($conn);
