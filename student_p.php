    ...
    while($row = mysqli_fetch_assoc($sql)){
     ...
     <div class="container">
        ...
        <div class="row">
         ...
         <div class="col-md-4 text-center">
          <input type="text" rows="2" class="form-control input-xs"  name="address" value="<?php echo $row['ADDRESS'] ?>" >
        ...
        <div class="row">
         ...
         <div class="col-md-4 text-center">
          <input type="text" rows="2" class="form-control input-xs"  name="pg" value="<?php echo $row['PARENT_GUARDIAN'] ?>">
        ...
        <div class="row">
         ...
         <div class="col-md-4 text-center">
          <input type="text" class="form-control input-xs"  name="icc" value="<?php echo $row['INT_COURSE_COMP'] ?>" >
