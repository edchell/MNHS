                      ...
                      $result1 = mysqli_query($conn, $sql1);
                        if ($row1 = mysqli_fetch_assoc($result1)) {
                          ...
                          $result3 = mysqli_query($conn, $sql3);
                            if ($row2 = mysqli_fetch_assoc($result3)) {
            ?>
         <input type="text" name="adviser" class="form-control" id ="adviser" readonly value="<?php echo htmlspecialchars($row['ADVISER']); ?>">
         <?php
                  }
                }
              }
              ...
              include 'db.php'; 
                ...
                if ($row = mysqli_fetch_assoc($result)) {
                  ...
                  if ($row1 = mysqli_fetch_assoc($result1)) {
                    ...
                    if ($row2 = mysqli_fetch_assoc($result3)) {
            ?>
         <input type="text" name="rank" class="form-control" id ="ra" value="<?php echo htmlspecialchars($row['RANK']); ?>" readonly>
         <?php
                  }
                }
              }
