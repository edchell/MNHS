...
$page = $_GET['page'];
$pages = array('home', 'Students', 'subjects','student_p','records','record','addrecord','addrecord_update','report','program','statistical','form137','list_report','student_report','users','school_year','grade','advisers','database','candidates','candidates_list', 'candidates_report','logs');
if (!empty($page)) {
