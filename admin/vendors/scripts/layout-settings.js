(function () {
	...
	$(document).ready(function () {
		...
		var currentOptions = {
			headerBackground: "header-primary",
		...
		var header_light = jQuery(".header-primary");

		header_dark.click(function () {
			"use strict";
			jQuery(this).addClass("active");
			header_light.removeClass("active");
			body.removeClass("header-primary").addClass("header-dark");
		...
		header_light.click(function () {
			...
			body.removeClass("header-dark").addClass("header-primary");

			//Store in local storage
			setOptions("headerBackground", "header-primary");
		});

		//Click for current options
		if (currentOptions.headerBackground === "header-primary") {
